    ...
    return new Promise((resolve, reject) => {
	    ...
	    case "cratex": {
            ...
            case "ihostmn_buy&sell": {
                exdata.link = `https://ihostmn.com/buysell.php?market=MON2BTC`;
                js_request(`https://ihostmn.com/api/v1/buysell/public/get_market_info?market=MON2BTC`, res => {
...
class BotCommand {
        ...
        return Promise.all([
            ...
            for (let stat of conf.statorder) {
                switch (stat) {
                    ...
                    case "collateral": { 
                        if (valid.blockcount)
                            embed.addField("Collateral", stage.coll1.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") + " " + conf.coin, true);
                        break;
                    }
                    case "mnreward": { 
                        if (valid.blockcount)
                            embed.addField("MN Reward", stage.mn1 + " " + conf.coin, true);
                        break;
                    }
                    case "powreward": { 
                    ...
                    case "zeonfund": {
                        if (stage.zeon !== undefined && valid.blockcount)
                            embed.addField("Zeon Fund Fee", stage.zeon + " " + conf.coin, true);
                        break;
                    }
                    case "locked": { 
                        if (valid.blockcount && valid.mncount1 && valid.supply)
                            embed.addField("Locked", (mncount1 * stage.coll1).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") + " " + conf.coin + " (" + (mncount1 * stage.coll1 / supply * 100).toFixed(2) + "%)", true);
                        break;
                    }
                    case "avgmnreward": {
                        if (valid.mncount1)
        ...
        return Promise.all([
            ...
            for (let stat of conf.statorder) {
                switch (stat) {
                    ...
                    case "collateral": {
                        if (valid.blockcount)
                            embed.addField("Collateral", stage.coll2.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") + " " + conf.coin, true);
                        break;
                    }
                    case "mnreward": {
                        if (valid.blockcount)
                            embed.addField("MN Reward", stage.mn2 + " " + conf.coin, true);
                        break;
                    }
                    case "powreward": {
                        if (stage.pow !== undefined && valid.blockcount)
                    ...
                    case "locked": {
                        if (valid.blockcount && valid.mncount2 && valid.supply)
                            embed.addField("Locked", (mncount2 * stage.coll2).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") + " " + conf.coin + " (" + (mncount2 * stage.coll2 / supply * 100).toFixed(2) + "%)", true);
                        break;
                    }
                    case "avgmnreward": {
                        if (valid.mncount2)
        ...
        return Promise.all([
            ...
            for (let stat of conf.statorder) {
                switch (stat) {
                    ...
                    case "collateral": {
                        if (valid.blockcount)
                            embed.addField("Collateral", stage.coll3.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") + " " + conf.coin, true);
                        break;
                    }
                    case "mnreward": {
                        if (valid.blockcount)
                            embed.addField("MN Reward", stage.mn3 + " " + conf.coin, true);
                        break;
                    }
                    case "powreward": {
                        if (stage.pow !== undefined && valid.blockcount)
                    ...
                    case "locked": {
                        if (valid.blockcount && valid.mncount3 && valid.supply)
                            embed.addField("Locked", (mncount3 * stage.coll3).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") + " " + conf.coin + " (" + (mncount3 * stage.coll3 / supply * 100).toFixed(2) + "%)", true);
                        break;
                    }
                    case "avgmnreward": {
                        if (valid.mncount3)
    ...
    stats() {
        return Promise.all([
            ...
            new Promise((resolve, reject) => resolve(request_mncount3())),
            new Promise((resolve, reject) => resolve(bash_cmd(conf.requests.supply)))
        ]).then(([blockcount, mncount, mncount1, mncount2, mncount3, supply]) => {
            ...
            for (let stat of conf.statorder) {
                switch (stat) {
                    ...
                    case "mncount": {
                        if (valid.mncount)
                            embed.addField("Total MN Count", mncount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ","), true);
                        break;
                    }
                    case "mncount1": {
                        if (valid.mncount1)
                            embed.addField("Light MN Count", mncount1.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ","), true);
                        break;
                    }
                    case "mncount2": {
                        if (valid.mncount2)
                            embed.addField("Medium MN Count", mncount2.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ","), true);
                        break;
                    }
                    case "mncount3": {
                        if (valid.mncount3)
                            embed.addField("Full MN Count", mncount13toString().replace(/\B(?=(\d{3})+(?!\d))/g, ","), true);
                        break;
                    }
                    case "supply": { 
                        if (valid.supply)
                    ...
                    case "collateral1": {
                        if (valid.blockcount)
                            embed.addField("Collateral Light", stage.coll1.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") + " " + conf.coin, true);
                        break;
                    }
                    case "collateral2": {
                        if (valid.blockcount)
                            embed.addField("Collateral Medium", stage.coll2.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") + " " + conf.coin, true);
                        break;
                    }
                    case "collateral3": {
                        if (valid.blockcount)
                            embed.addField("Collateral Full", stage.coll3.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") + " " + conf.coin, true);
                        break;
                    }
                    case "mnreward1": { 
                        if (valid.blockcount)
                            embed.addField("MN Light Reward", stage.mn1 + " " + conf.coin, true);
                        break;
                    }
                    case "mnreward2": {
                        if (valid.blockcount)
                            embed.addField("MN Medium Reward", stage.mn2 + " " + conf.coin, true);
                        break;
                    }
                    case "mnreward3": {
                        if (valid.blockcount)
                            embed.addField("MN Full Reward", stage.mn3 + " " + conf.coin, true);
                        break;
                    }
                    case "powreward": { 
                        if (stage.pow !== undefined && valid.blockcount)
                    ...
                    case "locked": { 
                        if (valid.blockcount && valid.mncount1 && valid.mncount2 && valid.mncount3 && valid.supply)
                            embed.addField("Total Locked", (mncount1 * stage.coll1 + mncount2 * stage.coll2 + mncount3 * stage.coll3).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") + " " + conf.coin + " (" + ((mncount1 * stage.coll1 + mncount2 * stage.coll2 + mncount3 * stage.coll3) / supply * 100).toFixed(2) + "%)", true);
                        break;
                    }
                    case "avgmnreward": {
                        if (valid.mncount1)
    ...
    stages() {
        return new Promise((resolve, reject) => resolve(bash_cmd(conf.requests.blockcount))).then(blockcount => {
            ...
            let embed = new Discord.RichEmbed();
            embed.title = conf.coin + " Stages - ZEON Rewards are Based on a See-Saw Reward System \n POS and MN Rewards are approximate earnings :money_with_wings:";
            embed.color = conf.color.coininfo;
            embed.timestamp = new Date();
            ...
            if (isNaN(blockcount) && blockcount.trim() !== "") {
                ...
                for (let i = stgindex; i < conf.stages.length && embed.fields.length < 25; i++) {
                    ...
                    embed.addField(
                        ...
                        (laststage.coll1 < conf.stages[i].coll1 && i !== stgindex ? "_MN Collateral Change Tier-1:_ " + conf.stages[i].coll1 + "\n" : "") + 
                        (laststage.coll2 < conf.stages[i].coll2 && i !== stgindex ? "_Tier-2:_ " + conf.stages[i].coll2 + "\n" : "") +
                        (laststage.coll3 < conf.stages[i].coll3 && i !== stgindex ? "_Tier-3:_ " + conf.stages[i].coll3 + "\n" : "") +
                        (conf.stages[i].brt  !== undefined ? "_Block Reward:_ "  + conf.stages[i].brt  + "\n" : "") +
                        (conf.stages[i].mn1  !== undefined ? "_MasterNode Block Reward Tier-1---->_ "  + conf.stages[i].mn1  + "\n" : "") + 
                        (conf.stages[i].mn2  !== undefined ? "_Tier-2---->_ "  + conf.stages[i].mn2  + "\n" : "") +
                        (conf.stages[i].mn3  !== undefined ? "_Tier-3---->_ "  + conf.stages[i].mn3  + "\n" : "") +
                        (conf.stages[i].pow !== undefined ? "_POW Reward:_ " + conf.stages[i].pow + "\n" : "") +
                        (conf.stages[i].pos !== undefined ? "_POS Avg-Reward:_ " + conf.stages[i].pos + "\n" : "") +
                        (conf.stages[i].zeon !== undefined ? "_ZEON Fund:_ " + conf.stages[i].zeon + "\n" : "") +
    ...
    earnings(mns1 , mns2, mns3 ) {
		...
		let stage2 = get_stage2(blockcount);
                ...
                let coinday1 = 86400 / conf.blocktime / mncount1 * stage1.mn1;
                let coinday2 = 86400 / conf.blocktime / mncount2 * stage2.mn2;
		let coinday3 = 86400 / conf.blocktime / mncount3 * stage3.mn3;    
                ...
                this.fn_send({
		            ...
		            {
                                name: "ROI Level 1",
                                value: (36500 / (stage1.coll1 / coinday1)).toFixed(2) + "%\n" + (stage1.coll1 / coinday1).toFixed(2) + " days",
                                inline: true
                            },
		            {
                                name: "ROI Level 2",
                                value: (36500 / (stage2.coll2 / coinday2)).toFixed(2) + "%\n" + (stage2.coll2 / coinday2).toFixed(2) + " days",
                                inline: true
                            },
		            {
                                name: "ROI Level 3",
                                value: (36500 / (stage3.coll3 / coinday3)).toFixed(2) + "%\n" + (stage3.coll3 / coinday3).toFixed(2) + " days",
                                inline: true
                            },
				
                            {
                                name: "MN Price Level 1",
                                value: (stage1.coll1 * avgbtc).toFixed(8) + " BTC\n" + (stage1.coll1 * avgbtc * priceusd).toFixed(2) + " USD",
                                inline: true
                            },
			    {
                                name: "MN Price Level 2",
                                value: (stage2.coll2 * avgbtc).toFixed(8) + " BTC\n" + (stage2.coll2 * avgbtc * priceusd).toFixed(2) + " USD",
                                inline: true
                            },
	                    {
                                name: "MN Price Level 3",
                                value: (stage3.coll3 * avgbtc).toFixed(8) + " BTC\n" + (stage3.coll3 * avgbtc * priceusd).toFixed(2) + " USD",
                                inline: true
                            },
                            {
                                name: "Time to get 1 MN Level 1",
                                value:  mns1 > 0 ? ((stage1.coll1 / (coinday1 * mns1)).toFixed(2) + " days") :  "----" ,
                                inline: true
                            },
                            {
                                name: "Time to get 1 MN Level 2",
                                value:  mns2 > 0 ? ((stage2.coll2 / (coinday2 * mns2)).toFixed(2) + " days" ) : "----",
                                inline: true
                            },
                            {
                                name: "Time to get 1 MN Level 3",
                                value:  mns3 > 0 ? ((stage3.coll3 / (coinday3 * mns3)).toFixed(2) + " days" ) : "----",
                                inline: true
                            }
    ...
    earnings1(mns) {
        return Promise.all([
            ...
            if (valid.blockcount && valid.mncount1) {
                ...
                let stage = get_stage1(blockcount);
                let coinday = 86400 / conf.blocktime / mncount1 * stage.mn1;
                this.fn_send({
                    embed: {
                        ...
                        fields: [
                            {
                                name: "ROI",
                                value: (36500 / (stage.coll1 / coinday)).toFixed(2) + "%\n" + (stage.coll1 / coinday).toFixed(2) + " days",
                                inline: true
                            },
                            {
                                name: "MN Price",
                                value: (stage.coll1 * avgbtc).toFixed(8) + " BTC\n" + (stage.coll1 * avgbtc * priceusd).toFixed(2) + " USD",
                                inline: true
                            }
                        ].concat(mns === 1 ? [{ name: "\u200b", value: "\u200b", inline: true }] : [
                            {
                                name: "Time to get 1 MN",
                                value: (stage.coll1 / (coinday * mns)).toFixed(2) + " days",
                                inline: true
                            }
    ...
    earnings2(mns) {
        return Promise.all([
            ...
            if (valid.blockcount && valid.mncount2) {
                mns = mns !== undefined && mns > 0 ? mns : 1;
                let stage = get_stage2(blockcount);
                let coinday = 86400 / conf.blocktime / mncount2 * stage.mn2;
                this.fn_send({
                    embed: {
                        ...
                        fields: [
                            {
                                name: "ROI",
                                value: (36500 / (stage.coll2 / coinday)).toFixed(2) + "%\n" + (stage.coll2 / coinday).toFixed(2) + " days",
                                inline: true
                            },
                            {
                                name: "MN Price",
                                value: (stage.coll2 * avgbtc).toFixed(8) + " BTC\n" + (stage.coll2 * avgbtc * priceusd).toFixed(2) + " USD",
                                inline: true
                            }
                        ].concat(mns === 1 ? [{ name: "\u200b", value: "\u200b", inline: true }] : [
                            {
                                name: "Time to get 1 MN",
                                value: (stage.coll2 / (coinday * mns)).toFixed(2) + " days",
                                inline: true
                            }
                        ]).concat(earn_fields(coinday * mns, avgbtc, priceusd)),
                        timestamp: new Date()
    ...
    earnings3(mns) {
        return Promise.all([
            ...
            if (valid.blockcount && valid.mncount3) {
                mns = mns !== undefined && mns > 0 ? mns : 1;
                let stage = get_stage3(blockcount);
                let coinday = 86400 / conf.blocktime / mncount3 * stage.mn3
                this.fn_send({
                    embed: {
                        ...
                        fields: [
                            {
                                name: "ROI",
                                value: (36500 / (stage.coll3 / coinday)).toFixed(2) + "%\n" + (stage.coll3 / coinday).toFixed(2) + " days",
                                inline: true
                            },
                            {
                                name: "MN Price",
                                value: (stage.coll3 * avgbtc).toFixed(8) + " BTC\n" + (stage.coll3 * avgbtc * priceusd).toFixed(2) + " USD",
                                inline: true
                            }
                        ].concat(mns === 1 ? [{ name: "\u200b", value: "\u200b", inline: true }] : [
                            {
                                name: "Time to get 1 MN",
                                value: (stage.coll3 / (coinday * mns)).toFixed(2) + " days",
                                inline: true
                            }
                        ]).concat(earn_fields(coinday * mns, avgbtc, priceusd)),
                        timestamp: new Date()
    ...
    my_earnings() {
        ...
        Promise.all([
            ...
            if (valid.blockcount && valid.mncount1 && valid.mncount2 && valid.mncount3) {
                let stage = get_stage(blockcount);
                let coinday = 86400 / conf.blocktime / [(mncount1 * stage.mn1) + (mncount2 * stage.mn2) + (mncount3 * stage.mn3)];
                this.fn_send({
                    embed: {
                        title: "User Earnings (" + mns + " Combined MNs)",
                        color: conf.color.coininfo,
                        fields: [
                            {
                                name: "Time to get a Light MasterNode",
                                value: (stage.coll1 / (coinday * mns)).toFixed(2) + " days"
                            },
                            {
                                name: "Time to get a Medium MasterNode",
                                value: (stage.coll2 / (coinday * mns)).toFixed(2) + " days"
                            },
                            {
                                name: "Time to get a Full MasterNode",
                                value: (stage.coll3 / (coinday * mns)).toFixed(2) + " days"
                            }
            ...
            embed: {
                ...
                fields: [
                    ...
                    },
                    {
                        name: "Stats:",
                        value:
                            " - **" + conf.prefix + "stats** : get the current level total stats of the " + conf.coin + " blockchain\n" +
